...
class ToNikahAdd extends StatefulWidget {
  ToNikahAdd({Key? key}) : super(key: key);

  @override
  _ToNikahAddState createState() => _ToNikahAddState();
}

class _ToNikahAddState extends State<ToNikahAdd> {
  ...
  Widget submitBtn() {
    return InkWell(
      onTap: () async {
        ...
        // Store data in the "users/nikahList" subcollection
