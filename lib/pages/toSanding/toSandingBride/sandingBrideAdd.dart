...
class SandingBrideAdd extends StatefulWidget {
  SandingBrideAdd({Key? key}) : super(key: key);

  @override
  _SandingBrideAddState createState() => _SandingBrideAddState();
}

class _SandingBrideAddState extends State<SandingBrideAdd> {
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        categoryChip("Safety", 0xFFFF6D6E, Icons.healing),
                      ],
                    ),
                    SizedBox(
                      height: 50,
  ...
  Widget submitBtn() {
    return InkWell(
      onTap: () async {
        ...
        // Store data in the "users/sandingbrideList" subcollection
