...
class sandingPackages extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> weddingPackagesCentral = [
    {
      'name': 'Selangor Wedding Package',
      'links': [
        {
          'subName': 'Grand Ammara',
        ...
        {
          'subName': 'Najiha Online',
          'link': Uri.encodeFull('https://najihaonline.com/')
        },
        {
          'subName': 'Laman Perkahwinan',
  ...
  final List<Map<String, dynamic>> weddingPackagesNorth = [
    {
      'name': 'Kedah Wedding Package',
      'links': [
        {
          'subName': 'Aman Wedding Package',
          'link': Uri.encodeFull(
              'https://amanhomestay4u.com/Pakej_perkahwinan.html')
        },
        {
          'subName': 'Hotel Darul Aman Wedding Package',
          'link': Uri.encodeFull(
              'https://hoteldarulaman.com.my/pakej-perkahwinan-hd-jitra/')
        },
        {
          'subName': 'Hidayah Catering',
    ...
    },
    {
      ...
      'links': [
        ...
        {
          'subName': 'Bertam Resort Wedding Package',
        ...
        {
          'subName': 'The Light Hotel Wedding Package',
          'link': Uri.encodeFull('https://thelighthotelpg.com/events-weddings/')
        },
        {
          'subName': 'Shangri-la Wedding Package',
          'link': Uri.encodeFull(
  ...
  final List<Map<String, dynamic>> weddingPackagesEast = [
    {
  ...
  final List<Map<String, dynamic>> weddingPackagesEastM = [
    {
      'name': 'Sabah Wedding Package',
      'links': [
        {
          'subName': 'Kharisma Katering',
    ...
    },
    {
      ...
      'links': [
        {
          'subName': 'Wedding Project 2U',
          'link': Uri.encodeFull('https://weddingproject2u.com/')
        },
        {
          'subName': 'Sabariah Wedding Package',
          'link': Uri.encodeFull(
  ...
  final List<Map<String, dynamic>> weddingPackagesSouth = [
    {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            // North List
            buildListViewWithTitle(
              title: 'Northern Region',
              itemCount: weddingPackagesNorth.length,
              itemBuilder: (context, index) {
                final package = weddingPackagesNorth[index];
                return DropdownCard(
            ...
            SizedBox(
                height: 20), // Adjust the spacing between ListViews if needed
            // East List
            buildListViewWithTitle(
              title: 'Eastern Region',
              itemCount: weddingPackagesEast.length,
              itemBuilder: (context, index) {
                final package = weddingPackagesEast[index];
                return DropdownCard(
                  packageName: package['name'],
                  subItems: List<Map<String, String>>.from(package['links']),
                );
            ...
            buildListViewWithTitle(
              ...
              itemCount: weddingPackagesCentral.length,
              itemBuilder: (context, index) {
                final package = weddingPackagesCentral[index];
                return DropdownCard(
                  packageName: package['name'],
                  subItems: List<Map<String, String>>.from(package['links']),
                );
            ...
            buildListViewWithTitle(
              ...
              itemCount: weddingPackagesSouth.length,
              itemBuilder: (context, index) {
                final package = weddingPackagesSouth[index];
                return DropdownCard(
                  packageName: package['name'],
                  subItems: List<Map<String, String>>.from(package['links']),
                );
            ...
            // Sabah Sarawak List
            buildListViewWithTitle(
              title: 'East Malaysia Region',
              itemCount: weddingPackagesEastM.length,
              itemBuilder: (context, index) {
                final package = weddingPackagesEastM[index];
                return DropdownCard(
                  packageName: package['name'],
                  subItems: List<Map<String, String>>.from(package['links']),
                );
  ...
  Widget build(BuildContext context) {
    return Card(
      margin: EdgeInsets.symmetric(
          vertical: 5, horizontal: 7), // Add horizontal padding
      child: Column(
        children: [
          ListTile(
